            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <br><br>
                        <div class="col-sm-2">
                            <label><a class="btn btn-warning btn-sm" style="padding: 8px 0px 0px 0px; margin-top: -3px; color: white; width: 110px; height: 40px;" href="karyawanAutoID" role="button">Tambah Data</a></label>
                        </div>

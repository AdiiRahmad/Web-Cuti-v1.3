 ...
 * @author AdiRahmad
 */
@WebServlet(name = "DetailCutiAutoIDPim", urlPatterns = {"/detailCutiAutoIDPim"})
public class DetailCutiAutoIDPim extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            dis = request.getRequestDispatcher("view/pimpinan/insert/detailcuti.jsp");

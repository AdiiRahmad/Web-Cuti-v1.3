            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <br><br>
                        <div class="col-sm-2">
                            <label><a class="btn btn-warning btn-sm" style="padding: 8px 0px 0px 0px; margin-top: -3px; color: white; width: 110px; height: 40px;" href="setujuCutiAutoIDPim" role="button">Tambah Data</a></label>
                        </div>
                            ...
                            <table id="example" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                ...
                                %>
                                    ...
                                    <tr>
                                        ...
                                        <td><%= dc.getStatus()%></td>
                                        <td><center>
                                    <a class="btn btn-primary btn-xs" href="detailCutiU?id=<%= dc.getIdDetailCuti()%>" role="button">Tindakan</a>

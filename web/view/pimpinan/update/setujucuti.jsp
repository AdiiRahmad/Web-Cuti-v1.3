            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li><a href="indexadmin.html"><i class="fa fa-building-o"></i> <span>Home</span></a></li>
                        ...
                        <li><a href="../laporan/LaporanPerorangan.jsp"><i class="fa fa-upload"></i> <span>Laporan</span></a></li>
                    </ul>
                </section>
                <!-- /.sidebar -->
            </aside>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body" style="color: #3f3f3f;">
                                    <div class="col-sm-12 col-sm-offset-4">
                                        <form action="prosesUpdateDetailCutiPim">
                                            <%
                                                Object datadetailcuti = session.getAttribute("DetailCutiU");
                                                ...
                                                String tanggalMulai = dateFormat.format(decut.getTanggalMulai());
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="txtNik"  class="form-control">
                                                    <% for (Object data : datas1) {
                                                            ...
                                                            if (k.getNik().equals(decut.getNik())) {
                                                    %>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="txtIdCuti"  class="form-control">
                                                    <% for (Object data : datas2) {
                                                            Cuti cu = (Cuti) data;
                                                            if (cu.getIdCuti().equals(decut.getIdCuti().getIdCuti())) {
                                                    %>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="tanggalMulai" placeholder="Tanggal Mulai Cuti" name="txtTanggalMulaiCuti" value="<%= tanggalMulai%>" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="status" placeholder="Status" name="txtStatus" value="<%= decut.getStatus()%>" />
                                            </div>
                                            <div class="form-group">

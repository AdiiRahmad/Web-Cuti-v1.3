            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        ...
                        <br><br>
                        <div class="col-sm-4">
                            <label><a class="btn btn-warning btn-sm" style="padding: 8px 0px 0px 0px; margin-top: -3px; color: white; width: 140px; height: 40px;" href="cetakKeseluruhanController" role="button">Download All</a></label>&nbsp;&nbsp;
                            <label><a class="btn btn-warning btn-sm" style="padding: 8px 0px 0px 0px; margin-top: -3px; color: white; width: 140px; height: 40px;" href="controllerPrintSearch" role="button">Download Search</a></label>
                        </div>

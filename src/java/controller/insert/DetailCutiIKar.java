 ...
 * @author AdiRahmad
 */
@WebServlet(name = "DetailCutiIKar", urlPatterns = {"/detailCutiIKar"})
public class DetailCutiIKar extends HttpServlet {
...
//        String jabatan = request.getParameter("txtJabatan");
        String pesanI = "Gagal Menambah Data";
...
//            CII.getById(jeniscuti);
            ...
            if (dcdao.update(dc)) {
                pesanI = "Berhasil Menambah Data dengan ID : " + dc.getIdDetailCuti();
            }
            ...
            session.setAttribute("pesanI", pesanI);
            dispatcher = request.getRequestDispatcher("detailCutiControllerKar");
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DetailCutiIKar.class

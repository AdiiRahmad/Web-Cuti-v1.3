 ...
 * @author AdiRahmad
 */
@WebServlet(name = "DetailCutiAutoIDKar", urlPatterns = {"/detailCutiAutoIDKar"})
public class DetailCutiAutoIDKar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            dis = request.getRequestDispatcher("view/karyawan/insert/detailcuti.jsp");
